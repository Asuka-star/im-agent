...
class Settings(BaseSettings):
    ...
    xiaomi_llm_api_key: str = Field(default="", alias="XIAOMI_LLM_API_KEY")
    xiaomi_llm_base_url: str = Field(default="", alias="XIAOMI_LLM_BASE_URL")
    xiaomi_llm_model: str = Field(default="", alias="XIAOMI_LLM_MODEL")
    ...
    langgraph_shadow_mode: bool = Field(default=False, alias="LANGGRAPH_SHADOW_MODE")
    langgraph_checkpoint_enabled: bool = Field(default=False, alias="LANGGRAPH_CHECKPOINT_ENABLED")
    langgraph_max_parallel_workers: int = Field(default=3, alias="LANGGRAPH_MAX_PARALLEL_WORKERS")
    langgraph_node_timeout_seconds: float = Field(default=90.0, alias="LANGGRAPH_NODE_TIMEOUT_SECONDS")
    langgraph_llm_timeout_seconds: float = Field(default=30.0, alias="LANGGRAPH_LLM_TIMEOUT_SECONDS")
    langgraph_require_confirm_destructive: bool = Field(default=True, alias="LANGGRAPH_REQUIRE_CONFIRM_DESTRUCTIVE")
