...
class CanvasArtifactTests(unittest.TestCase):
    def test_canvas_service_persists_flow_scene(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertTrue((Path(tmpdir) / "Architecture-run_canvas.png").is_file())
            ...
            self.assertEqual(artifact["preview"]["exports"]["png"], "/api/artifacts/canvas/Architecture-run_canvas.png")
